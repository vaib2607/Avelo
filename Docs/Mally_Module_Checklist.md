...
- [x] `Docs/Mally_Master_PRD.md` — product, screens, fields, errors, shortcuts
- [x] `Docs/Mally_Architecture.md` — layers, naming, dependency rules
- [x] `Docs/Mally_Rules.md` — non-negotiables
- [x] `Docs/Mally_Schema.md` — SQLite schema, constraints, indexes
- [x] `Docs/Mally_Module_Checklist.md` — this file
- [x] `Docs/Mally_Naming_Freeze.md` — every name locked
...
- On confirm, a `.sqlite` file is created at `Application Support/Mally/Companies/<uuid>.sqlite` and seeded with the full schema + default voucher types + default groups + default ledgers.
...
- Backup export to chosen `.mallybackup` (zip of the SQLite file + sidecar manifest).
- Restore from `.mallybackup` creates a new company in the picker.
