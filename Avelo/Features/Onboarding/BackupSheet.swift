...
public struct BackupSheet: View {
    ...
    public var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("Save a snapshot of the current company database. The backup is portable and can be restored on any Mac running Avelo.")
    ...
    private func run() {
        ...
        Task {
            ...
            do {
                ...
                panel.nameFieldStringValue = "AveloBackup-\(ctx.companyId.uuidString.prefix(8)).avelobackup"
