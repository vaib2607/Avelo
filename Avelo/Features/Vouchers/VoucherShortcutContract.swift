...
enum VoucherShortcutContract {
    static let editorRows: [(key: String, description: String)] = [
        ...
        ("⌘N in Account picker", "Create an eligible account"),
        ("⌘E", "Toggle item-invoice mode in a new eligible Sales/Purchase voucher"),
        ("⌘Z", "Undo the last line/field change"),
        ("⇧⌘Z", "Redo")
    ]

    static let tableRows: [(key: String, description: String)] = [
        ("⌘D", "Duplicate the selected voucher"),
    ...
    static func editorTitle(for key: String) -> String {
        ...
        case "⌘N in Account picker": return "Create account"
        case "⌘E": return "Toggle item invoice"
        case "⌘Z": return "Undo"
        case "⇧⌘Z": return "Redo"
