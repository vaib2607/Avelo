...
public struct MigrationV025: Migration {
    public let version: SchemaVersion = .v25
    public let description = "Add dedicated cheque bounce and re-presentation audit actions"
    ...
    public func up(_ db: SQLiteDatabase) throws {
        ...
        try db.execute("ALTER TABLE avelo_audit_events RENAME TO avelo_audit_events_v24;")
        try db.execute(
            """
        ...
        try db.execute(
            ...
            FROM avelo_audit_events_v24
            ORDER BY company_id ASC, sequence_number ASC;
            """
        )
        try db.execute("DROP TABLE avelo_audit_events_v24;")
