...
public struct MigrationV012: Migration {
    public let version: SchemaVersion = .v12
    public let description = "Add keyed audit-chain integrity columns and backfill signatures"
